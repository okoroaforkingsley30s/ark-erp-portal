...
useEffect(() => {
  ...
  if (loadingSession) {
    return (
      <div className="fixed inset-0 overflow-y-auto bg-gradient-to-br from-[#08153d] via-[#0b1f5e] to-[#102969] p-4">
  ...
  if (success) {
    return (
      <div className="fixed inset-0 overflow-y-auto overscroll-contain bg-gradient-to-br from-[#08153d] via-[#0b1f5e] to-[#102969] px-3 py-4 sm:p-6">
        <div className="min-h-full flex items-center justify-center">

        <Card className="p-6 sm:p-8 max-w-sm w-full text-center space-y-4">
  ...
  return (
    <div className="fixed inset-0 overflow-y-auto overscroll-contain bg-gradient-to-br from-[#08153d] via-[#0b1f5e] to-[#102969] px-3 py-3 sm:px-4 sm:py-6">
      <div className="min-h-full flex items-start sm:items-center justify-center">

      <Card className="p-4 xs:p-5 sm:p-6 md:p-8 max-w-md w-full mx-auto my-3 sm:my-6 space-y-4 sm:space-y-5 border-0 shadow-2xl">

        <div className="text-center space-y-2 sm:space-y-3">

          <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-xl sm:rounded-2xl bg-amber-100 flex items-center justify-center mx-auto">
